# Lenguajes y Compiladores - Codes
...
- Validación de cadenas en notación FEN (Forsyth-Edwards Notation).  
- Generación de polinomios usando el **Triángulo de Pascal** y evaluación de f(x) = (x+1)^n, implementado en **dos lenguajes** y con medición de tiempo de ejecución.  
...
- **Analizador LR (LALR):** Desarrollado utilizando la biblioteca PLY (Python Lex-Yacc) para demostrar la potencia del análisis ascendente y el manejo natural de la recursión izquierda.

[Ir a la carpeta de los Analizadores Sintácticos](./03-Analizadores_Sintacticos/)
